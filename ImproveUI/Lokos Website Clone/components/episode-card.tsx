...
export function EpisodeCard({
  ...
  return (
    <motion.div
      whileHover={{ y: -5 }}
      className={`flex flex-col rounded-xl overflow-hidden bg-[#0A0A0A] border border-white/5 group ${className}`}
    >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative">
            <div className="relative w-24 h-24 rounded-xl overflow-hidden border-4 border-black/10 shadow-xl">
              <Image src={image || "/placeholder.svg"} alt={guest} fill className="object-cover" />
            </div>
